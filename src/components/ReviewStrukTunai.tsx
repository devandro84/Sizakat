...
interface ReviewStrukTunaiProps {
  headOfFamily: string;
  rtNumber: string;
  rwNumber: string;
  familyCount: number;
      ...
      <CardContent className="space-y-4">
        ...
        <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg space-y-2">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium dark:text-white">Tunai</span>
          </div>
        </div>
...
export default ReviewStrukTunai;