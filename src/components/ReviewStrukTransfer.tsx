...
interface ReviewStrukTransferProps {
  headOfFamily: string;
  rtNumber: string;
  familyCount: number;
  zakatAmount: number;
      ...
      <CardContent className="space-y-4">
        ...
        <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg space-y-2">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium dark:text-white">{rtNumber}</span>
          </div>
          <div className="flex justify-between">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium dark:text-white">Transfer Bank</span>
          </div>
        </div>
...
export default ReviewStrukTransfer;