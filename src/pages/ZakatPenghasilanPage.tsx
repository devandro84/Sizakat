...
import ZakatPenghasilanCalculator from '@/components/ZakatPenghasilanCalculator';

const ZakatPenghasilanPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pattern-bg">
      ...
      <div className="page-container py-8">
        ...
        <h2 className="text-2xl font-bold mb-6">Zakat Penghasilan</h2>
        
        <ZakatPenghasilanCalculator />
      </div>
    </div>
  );
};

export default ZakatPenghasilanPage;
